...
In root directory :
```
docker build -f docker/php/base/Dockerfile -t php:base .
...
In root directory :
```
docker build -f docker/php/dev/Dockerfile -t php:dev .
...
In root directory :
```
docker build -f docker/php/package/Dockerfile -t php:package .
...
In root directory :
```
docker build -f docker/nginx/base/Dockerfile -t nginx:base .
...
In root directory :
```
docker build -f docker/nginx/dev/Dockerfile -t nginx:dev .
